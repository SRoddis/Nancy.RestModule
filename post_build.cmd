...
REM.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:.\tools\NUnit.ConsoleRunner.3.2.1\tools\nunit3-console.exe -targetargs:".\FlyingMigratory.Test\bin\Debug\FlyingMigratory.Test.dll" -filter:"+[FlyingMigratory]* -[FlyingMigratory.Test]*" -register:user
 
REM.\tools\coveralls.net.0.6.0\tools\csmacnz.Coveralls.exe --opencover -i .\results.xml